            ...
            const response = await fetch(`${this.orchestratorUrl}/v1/chat`, {
                ...
                body: JSON.stringify({
                    messages: [
                        {
                            role: 'system',
                            content: 'You are an expert software architect and product manager. Your job is to analyze app requirements and create detailed technical specifications for modern web applications.'
                        },
                        {
                            role: 'user',
                            content: prompt
...
Respond with valid JSON only.`;
    ...
    fallbackAnalysis(description) {
        ...
        return {
            ...
            estimatedSize: complexity === 'simple' ? '1.8MB' : complexity === 'medium' ? '3.2MB' : '5.1MB'
        };
    }
